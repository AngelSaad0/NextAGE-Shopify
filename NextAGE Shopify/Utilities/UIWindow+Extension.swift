...
import UIKit
extension UIWindow {
    static func setRootViewController(storyboard: String, vcIdentifier: String, withTransition transition: UIView.AnimationOptions = .transitionCrossDissolve, duration: TimeInterval = 0.3) {
