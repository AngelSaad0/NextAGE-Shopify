...
let dummyReviews: [DumyReview] = [
    ...
    DumyReview(userName: "Grace Hall", userImage: "user7.png", date: "2024-08-25", review: "Love it! Would buy again.", rating: "5"),
    DumyReview(userName: "Henry King", userImage: "user8.png", date: "2024-08-24", review: "Average quality.", rating: "3"),
    DumyReview(userName: "Ivy Martinez", userImage: "user9.png", date: "2024-08-23", review: "Perfect fit and great material.", rating: "5"),
    DumyReview(userName: "Jack Wilson", userImage: "user10.png", date: "2024-08-22", review: "Product was damaged upon arrival.", rating: "2"),
    DumyReview(userName: "Karen Clark", userImage: "user1.png", date: "2024-08-21", review: "Very stylish and comfortable.", rating: "4"),
    DumyReview(userName: "Leo Young", userImage: "user2.png", date: "2024-08-20", review: "Terrible experience. Not recommended.", rating: "1")
]
