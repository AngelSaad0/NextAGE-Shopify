...
class NetworkManager {
    ...
    private func logError(_ error: Error, data: Data?) {
        ...
        func createCustomer(firstName: String, lastName: String, email: String, phone: String, password: String, completion: @escaping (CustomerInfo?) -> Void) {
            let url = "https://yourapi.com/customers" // Replace with your actual API endpoint
